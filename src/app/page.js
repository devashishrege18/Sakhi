...
const REDIRECT_TRANSLATIONS = {
  'hi-IN': { hospitals: 'पास के अस्पताल दिखा रही हूँ...', doctors: 'डॉक्टर से जोड़ रही हूँ...', wellness: 'सेहत के नुस्खे ला रही हूँ...', pharmacy: 'दवाई की दुकान खोल रही हूँ...', forum: 'चर्चा मंच पर ले जा रही हूँ...', ambulance: 'एम्बुलेंस भेज रही हूँ... घबराइए नहीं!', shelter: 'सुरक्षित आश्रय खोज रही हूँ...' },
  'bn-IN': { hospitals: 'কাছের হাসপাতাল দেখাচ্ছি...', doctors: 'ডাক্তারের সাথে যোগাযোগ করাচ্ছি...', wellness: 'স্বাস্থ্য টিপস আনছি...', pharmacy: 'ফার্মেসি খুলছি...', forum: 'ফোরামে নিয়ে যাচ্ছি...', ambulance: 'অ্যাম্বুলেন্স পাঠাচ্ছি... ঘাবড়াবেন না!', shelter: 'নিরাপদ আশ্রয় খুঁজছি...' },
  'te-IN': { hospitals: 'దగ్గరి ఆసుపత్రులు చూపిస్తున్నాను...', doctors: 'డాక్టర్‌తో కలుపుతున్నాను...', wellness: 'ఆరోగ్య చిట్కాలు తెస్తున్నాను...', pharmacy: 'ఫార్మసీ తెరుస్తున్నాను...', forum: 'చర్చ వేదికకు తీసుకెళ్తున్నాను...', ambulance: 'అంబులెన్స్ పంపుతున్నాను... భయపడకండి!', shelter: 'సురక్షిత ఆశ్రయం వెతుకుతున్నాను...' },
  'mr-IN': { hospitals: 'जवळचे रुग्णालय दाखवत आहे...', doctors: 'डॉक्तरांशी जोडत आहे...', wellness: 'आरोग्य टिप्स आणत आहे...', pharmacy: 'औषधाचे दुकान उघडत आहे...', forum: 'चर्चा मंचावर नेत आहे...', ambulance: 'रुग्णवाहिका पाठवत आहे... घाबरू नका!', shelter: 'सुरक्षित आश्रय शोधत आहे...' },
  'ta-IN': { hospitals: 'அருகிலுள்ள மருத்துவமனைகளைக் காட்டுகிறேன்...', doctors: 'மருத்துவரை இணைக்கிறேன்...', wellness: 'ஆரோக்கிய குறிப்புகளைத் திறக்கிறேன்...', pharmacy: 'மருந்தகத்தைத் திறக்கிறேன்...', forum: 'மன்றத்திற்கு அழைத்துச் செல்கிறேன்...', ambulance: 'ஆம்புலன்ஸ் அனுப்புகிறேன்... பயப்படாதீர்கள்!', shelter: 'பாதுகாப்பான தங்குமிடம் தேடுகிறேன்...' },
  'gu-IN': { hospitals: 'નજીકની હોસ્પિટલ બતાવી રહી છું...', doctors: 'ડોક્ટર સાથે જોડી રહી છું...', wellness: 'સ્વાસ્થ્ય ટિપ્સ લાવી રહી છું...', pharmacy: 'ફાર્મસી ખોલી રહી છું...', forum: 'ચર્ચા મંચ પર લઈ જઈ રહી છું...', ambulance: 'એમ્બ્યુલન્સ મોકલી રહી છું... ગભરાશો નહીં!', shelter: 'સુરક્ષિત આશ્રય શોધી રહી છું...' },
  'kn-IN': { hospitals: 'ಹತ್ತಿರದ ಆಸ್ಪತ್ರೆಗಳನ್ನು ತೋರಿಸುತ್ತಿದ್ದೇನೆ...', doctors: 'ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸುತ್ತಿದ್ದೇನೆ...', wellness: 'ಆರೋಗ್ಯ ಸಲಹೆಗಳನ್ನು ತರುತ್ತಿದ್ದೇನೆ...', pharmacy: 'ಔಷಧಾಲಯವನ್ನು ತೆರೆಯುತ್ತಿದ್ದೇನೆ...', forum: 'ವೇದಿಕೆಗೆ ಕರೆದೊಯ್ಯುತ್ತಿದ್ದೇನೆ...', ambulance: 'ಆಂಬ್ಯುಲೆನ್ಸ್ ಕಳುಹಿಸುತ್ತಿದ್ದೇನೆ... ಹೆದರಬೇಡಿ!', shelter: 'ಸುರಕ್ಷಿತ ಆಶ್ರಯ ಹುಡುಕುತ್ತಿದ್ದೇನೆ...' },
  'ml-IN': { hospitals: 'അടുത്തുള്ള ആശുപത്രികൾ കാണിക്കുന്നു...', doctors: 'ഡോക്ടറുമായി ബന്ധിപ്പിക്കുന്നു...', wellness: 'ആരോഗ്യ നിർദ്ദേശങ്ങൾ കൊണ്ടുവരുന്നു...', pharmacy: 'ഫാർമസി തുറക്കുന്നു...', forum: 'ഫോറത്തിലേക്ക് കൊണ്ടുപോകുന്നു...', ambulance: 'ആംബുലൻസ് അയക്കുന്നു... പേടിക്കരുത്!', shelter: 'സുരക്ഷിത അഭയകേന്ദ്രം തിരയുന്നു...' },
  'pa-IN': { hospitals: 'ਨੇੜਲੇ ਹਸਪਤਾਲ ਦਿਖਾ ਰਹੀ ਹਾਂ...', doctors: 'ਡਾਕਟਰ ਨਾਲ ਜੋੜ ਰਹੀ ਹਾਂ...', wellness: 'ਸਿਹਤ ਨੁਸਖੇ ਲਿਆ ਰਹੀ ਹਾਂ...', pharmacy: 'ਦਵਾਈ ਦੀ ਦੁਕਾਨ ਖੋਲ੍ਹ ਰਹੀ ਹਾਂ...', forum: 'ਚਰਚਾ ਮੰਚ ਤੇ ਲੈ ਜਾ ਰਹੀ ਹਾਂ...', ambulance: 'ਐਂਬੂਲੈਂਸ ਭੇਜ ਰਹੀ ਹਾਂ... ਘਬਰਾਓ ਨਾ!', shelter: 'ਸੁਰੱਖਿਅਤ ਆਸਰਾ ਲੱਭ ਰਹੀ ਹਾਂ...' },
  'en-IN': { hospitals: 'Showing nearby hospitals...', doctors: 'Connecting you to a doctor...', wellness: 'Opening wellness tips...', pharmacy: 'Opening pharmacy...', forum: 'Taking you to the forum...', ambulance: 'Sending ambulance... Stay calm!', shelter: 'Finding safe shelter...' }
};
...
const VOICE_FEATURES = {
  ...
  ambulance: {
    keywords: [
      // English - pregnancy/delivery emergencies
      'ambulance', 'pregnancy emergency', 'delivery', 'labor', 'contractions', 'water broke', 'bleeding heavily', 'miscarriage', 'pregnant', 'baby coming', 'labour pain', 'premature', 'c-section', 'cesarean',
      // Hindi
      'एम्बुलेंस', 'प्रसव', 'डिलीवरी', 'बच्चा आ रहा', 'दर्द हो रहा', 'खून बह रहा', 'गर्भवती', 'पानी निकल गया', 'लेबर पेन',
      // Bengali
      'অ্যাম্বুলেন্স', 'প্রসব', 'ডেলিভারি', 'বাচ্চা আসছে', 'রক্তক্ষরণ', 'গর্ভবতী',
      // Telugu
      'అంబులెన్స్', 'ప్రసవం', 'డెలివరీ', 'బిడ్డ వస్తోంది', 'రక్తస్రావం', 'గర్భిణి',
      // Tamil
      'ஆம்புலன்ஸ்', 'பிரசவம்', 'டெலிவரி', 'குழந்தை வருகிறது', 'ரத்தப்போக்கு', 'கர்ப்பிணி',
      // Marathi
      'रुग्णवाहिका', 'प्रसूती', 'बाळ येत आहे', 'रक्तस्त्राव', 'गर्भवती',
      // Gujarati
      'એમ્બ્યુલન્સ', 'પ્રસૂતિ', 'બાળક આવી રહ્યું છે', 'રક્તસ્રાવ', 'ગર્ભવતી',
      // Kannada
      'ಆಂಬ್ಯುಲೆನ್ಸ್', 'ಹೆರಿಗೆ', 'ಮಗು ಬರುತ್ತಿದೆ', 'ರಕ್ತಸ್ರಾವ', 'ಗರ್ಭಿಣಿ',
      // Malayalam
      'ആംബുലൻസ്', 'പ്രസവം', 'കുഞ്ഞ് വരുന്നു', 'രക്തസ്രാവം', 'ഗർഭിണി',
      // Punjabi
      'ਐਂਬੂਲੈਂਸ', 'ਜਣੇਪਾ', 'ਬੱਚਾ ਆ ਰਿਹਾ', 'ਖੂਨ ਵਹਿ ਰਿਹਾ', 'ਗਰਭਵਤੀ'
    ],
    route: '/ambulance'
  },
  shelter: {
    keywords: [
      // English - domestic violence/protection
      'shelter', 'domestic violence', 'abuse', 'husband beating', 'violence', 'help me', 'scared', 'threat', 'protection', 'rescue', 'safe house', 'beating me', 'hitting me', 'danger', 'unsafe', 'abusive',
      // Hindi
      'शेल्टर', 'हिंसा', 'मारपीट', 'पति मारता है', 'डर', 'बचाओ', 'सुरक्षा', 'मार रहा है', 'धमकी', 'घरेलू हिंसा',
      // Bengali
      'আশ্রয়', 'সহিংসতা', 'মারধর', 'স্বামী মারছে', 'ভয়', 'বাঁচাও', 'সুরক্ষা',
      // Telugu
      'ఆశ్రయం', 'హింస', 'కొట్టడం', 'భర్త కొడుతున్నాడు', 'భయం', 'రక్షించండి', 'రక్షణ',
      // Tamil
      'தங்குமிடம்', 'வன்முறை', 'அடிக்கிறார்', 'கணவன் அடிக்கிறார்', 'பயம்', 'காப்பாற்று', 'பாதுகாப்பு',
      // Marathi
      'आश्रय', 'हिंसाचार', 'मारहाण', 'नवरा मारतो', 'भीती', 'वाचवा', 'संरक्षण',
      // Gujarati
      'આશ્રય', 'હિંસા', 'મારપીટ', 'પતિ મારે છે', 'ડર', 'બચાવો', 'સુરક્ષા',
      // Kannada
      'ಆಶ್ರಯ', 'ಹಿಂಸೆ', 'ಹೊಡೆಯುತ್ತಿದ್ದಾರೆ', 'ಪತಿ ಹೊಡೆಯುತ್ತಿದ್ದಾರೆ', 'ಭಯ', 'ಕಾಪಾಡಿ', 'ರಕ್ಷಣೆ',
      // Malayalam
      'അഭയം', 'അക്രമം', 'തല്ലുന്നു', 'ഭർത്താവ് തല്ലുന്നു', 'പേടി', 'രക്ഷിക്കൂ', 'സംരക്ഷണം',
      // Punjabi
      'ਆਸਰਾ', 'ਹਿੰਸਾ', 'ਮਾਰਕੁੱਟ', 'ਪਤੀ ਮਾਰਦਾ ਹੈ', 'ਡਰ', 'ਬਚਾਓ', 'ਸੁਰੱਖਿਆ'
    ],
    route: '/shelter'
  },
};
...
export default function Home() {
  ...
  const sendMessage = async (text) => {
    ...
    setLoading(true);
    try {
      const res = await fetch('/api/chat', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ message: userMsg.content, history: messages, language: selectedLang.code }) });
    ...
    <div className="app">
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-text { font-size: 28px; font-weight: bold; color: #4338CA; font-family: 'Inter', 'Segoe UI', system-ui, sans-serif; text-shadow: 0 2px 8px rgba(67,56,202,0.3); }
